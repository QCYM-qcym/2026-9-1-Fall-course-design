...
use([LineChart, BarChart, DataZoomComponent, GridComponent, TooltipComponent, CanvasRenderer])
...
.trend-chart-canvas { height: clamp(260px, 30vh, 340px); width: 100%; }
.zoom-hint { margin: 2px 0 7px; color: #a1bbc8; font-size: 11px; }
