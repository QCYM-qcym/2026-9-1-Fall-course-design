...
前端 Vue 3/Vite/JavaScript/Element Plus/ECharts/Axios/Vue Router；后端 Java 17/Spring Boot 2.7.18/MyBatis-Plus/MyBatis XML/Maven 3.9.16；MySQL 8.0.16+。仍四表、19个API；当前Workbench/Comparison六要素，Trend保留T2M/PRECIP，详见[月级合成数据](../docs/MONTHLY-SYNTHETIC-DATA-1.md)。
